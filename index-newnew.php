...
<body>
	...
	<div id="wrapper">
		...
		<div id="welcome">
			The simplest way to keep track of stuff you want to hear.
		</div>
		...
		<div id="login-container">
			...
			<input id="sign-up" type="submit" value="show me my beautiful new page » " />
...
<h3>If you already have an account login below:</h3>
 ...
 -->            
		...
		<br><br><br><br><br>
		<div id="footer">
			<div id="footer-links"><a href="/about">About</a> | Created lovingly by <a href='http://tasteplug.com/wesley'>Wesley Zhao</a>, <a href="http://tasteplug.com/dan">Dan Shipper</a>, and <a href='http://tasteplug.com/ajay'>Ajay Mehta</a>. </div>
		</div>
